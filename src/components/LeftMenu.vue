<template>
    <div class="left-menu">
        ...
        <el-tooltip class="item" popper-class="lmtooltip" effect="dark" content="Расчет" placement="right">
            <el-button id="mathbtn" plain circle @click="goSolver"><i id="isqr" class="fas fa-square-root-alt"></i></el-button>
        </el-tooltip>
        ...
        <el-tooltip class="item" popper-class="lmtooltip" effect="dark" content="Настройки" placement="right">
            <el-button plain circle @click="goSetting"><i class="el-icon-set-up"></i></el-button>
        </el-tooltip>
        <el-tooltip class="item" popper-class="lmtooltip" effect="dark" content="О программе" placement="right">
            <el-button plain circle @click="goAbout"><i class="el-icon-info"></i></el-button>
        </el-tooltip>
    </div>
    <div id="botspace"></div>
    </div>
